...
export function Footer() {
  ...
  const [activePreviewStep, setActivePreviewStep] = useState(2);
  ...
  return (
    <footer className="site-footer bg-[#071324] text-slate-300 border-t border-slate-800/80 mt-auto relative overflow-hidden selection:bg-blue-600 selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="pt-16 sm:pt-20 pb-12">
          <div className="relative rounded-3xl bg-gradient-to-br from-[#0e223d]/90 via-[#102a4c]/80 to-[#0a182c]/90 border border-blue-500/30 p-8 sm:p-12 lg:p-14 overflow-hidden shadow-2xl backdrop-blur-2xl">
            ...
            <div className="footer-hero-grid relative z-10 grid grid-cols-1 items-center gap-10 lg:grid-cols-[1.08fr_.92fr] lg:gap-12">
              ...
              <div className="min-w-0">
                <div className="bg-[#0b1b30]/90 border border-blue-400/20 rounded-2xl p-5 sm:p-6 shadow-2xl backdrop-blur-md space-y-4">
                  ...
                  <div className="space-y-2.5">
                    {/* Step 1 */}
                    <button type="button" aria-pressed={activePreviewStep === 0} onClick={() => setActivePreviewStep(0)} className={`flex w-full items-center justify-between rounded-xl border p-3 text-left transition-colors ${activePreviewStep === 0 ? "border-emerald-500/40 bg-emerald-950/30" : "border-slate-800/80 bg-slate-900/60 hover:border-slate-700"}`}>
                    ...
                    {/* Step 2 */}
                    <button type="button" aria-pressed={activePreviewStep === 1} onClick={() => setActivePreviewStep(1)} className={`flex w-full items-center justify-between rounded-xl border p-3 text-left transition-colors ${activePreviewStep === 1 ? "border-emerald-500/40 bg-emerald-950/30" : "border-slate-800/80 bg-slate-900/60 hover:border-slate-700"}`}>
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 text-xs font-bold">
                          ✓
                        </div>
                    ...
                    {/* Step 3 */}
                    <button type="button" aria-pressed={activePreviewStep === 2} onClick={() => setActivePreviewStep(2)} className={`flex w-full items-center justify-between rounded-xl border p-3 text-left transition-colors ${activePreviewStep === 2 ? "border-blue-500/30 bg-blue-950/40" : "border-slate-800/80 bg-slate-900/60 hover:border-slate-700"}`}>
                      <div className="flex items-center gap-3">
        ...
        {/* ========================================================================= */}
        <div className="footer-feature-grid grid grid-cols-1 gap-4 border-y border-slate-800/80 py-10 sm:grid-cols-2 lg:grid-cols-4">
