...
export function Navbar() {
  ...
  return <header className="site-header"><div className="nav-shell">
    ...
    <div className="nav-actions"><button className="ai-pill" type="button"><span>✦</span> SatuAI</button><button className="login-button" type="button">Masuk</button><Link className="nav-cta" href="#mulai">Mulai Sekarang <span>→</span></Link></div>
